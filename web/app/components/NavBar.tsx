        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              style={{
                color: active ? "rgba(232,160,176,1)" : "rgba(255,255,255,0.3)",
                background: active ? "rgba(232,160,176,0.1)" : "transparent",
              }}
            >
              {item.icon}
              <span
                className="text-[11px] font-medium"
                style={{ color: active ? "rgba(232,160,176,1)" : "rgba(255,255,255,0.3)" }}
              >
                {item.label}
              </span>
            </Link>
